...
namespace WindowsFormsApp1
{
    class Creater
    {
        ...
        public string[] Creat_seq(int N, int Q, int F) //чтение строки
        {
        ...
        public int Peroid(string[] seq) //чтение строки
        {
            int per = 1;
            int step = 0;
        ...
        public int Max(int[] str) // Поиск d0
        {
            int max = 0;
            max = str[0];
        ...
        public bool Ver_Pirs(string[] seq, double[] alf) //чтение строки
        {
            double Sk = 0;
            double S = 0;
            double buf = 0;
